...
export const COMMANDS = {
  ...
  'release-bundle': ['release-bundle [task-id...] [--apply] [--sign --private-key <path>] [--json]', 'Generate release handoff artifacts.'],
  ...
  'fixture-board': ['fixture-board [kind] [--out <path>] [--task-count <n>] [--apply] [--json]', 'Generate deterministic board fixtures for tests, demos, and smoke checks.'],
