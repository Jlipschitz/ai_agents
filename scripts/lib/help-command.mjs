...
export const COMMANDS = {
  ...
  timeline: ['timeline [--task <id[,id...]>] [--agent <id[,id...]>] [--from <date>] [--to <date>] [--limit <n>] [--json]', 'Replay coordination journal, messages, audit entries, notes, and verification events.'],
  ...
  handoff: ['handoff <agent> <task-id> <note>|--summary <text> --next <text> [--blocker <text>] [--to <agent>]', 'Mark a task ready for structured handoff.'],
  'handoff-bundle': ['handoff-bundle <agent> <task-id> [--json]', 'Generate copy-ready task handoff context plus the recommended next command.'],
  next: ['next [agent-id] [--task <task-id>] [--json]', 'Recommend the exact next coordination command and why.'],
  ...
  'watch-tick': ['watch-tick --watcher-pid <pid> [--interval <ms>]', 'Run one internal watcher heartbeat and cleanup tick.'],
  ...
  'pr-summary': ['pr-summary [task-id...] [--title <text>] [--json]', 'Generate PR-ready handoff notes.'],
  ...
  'fixture-board': ['fixture-board [kind] [--out <path>] [--task-count <n>] [--reference-at <iso>] [--project-name <name>] [--workspace <label>] [--apply] [--json]', 'Generate deterministic board fixtures for tests, demos, and smoke checks.'],
  'migrate-config': ['migrate-config [--apply] [--json]', 'Add current optional config defaults.'],
  'policy-packs': ['policy-packs <list|inspect|apply> [pack] [--apply] [--json]', 'Inspect or apply reusable policy packs.'],
  ...
  'redact-check': ['redact-check [--paths <path[,path...]>] [--state-only] [--strict] [--json]', 'Scan coordination state and generated handoff text for sensitive values.'],
  ...
  completions: ['completions <list|powershell|bash|zsh> [--json]', 'Generate shell completion scripts for this repo.'],
