...
const COMMON_FLAGS = ['--json', '--help', '--config', '--root', '--coordination-dir', '--coordination-root', '--verbose', '--quiet', '--no-color', '--apply', '--keep-journal-lines', '--keep-message-lines', '--fail-under', '--priority', '--due-at', '--due', '--severity', '--approval-scope', '--scope', '--status', '--task', '--by', '--owner', '--producer', '--consumer', '--consumers', '--summary', '--note'];
